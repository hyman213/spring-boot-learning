...
/**
 * doEqualSharding： SQL中==规则<br/>
 * doInSharding: SQL中in的规则<br/>
 * doBetweenSharding: SQL中between的规则<br/>
 *
 * @Description: 单键分片策略，id>20使用database0库，其余使用database1库
 * @author: Hyman
 * @date: 2019/05/19 10:32
 * @version： 1.0.0
 */
@Component
